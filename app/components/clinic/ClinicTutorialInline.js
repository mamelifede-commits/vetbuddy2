...
function ClinicTutorialInline() {
  ...
  const sections = [
    ...
    { icon: CreditCard, title: 'Abbonamento e Pagamenti', color: 'bg-indigo-500', content: ['Starter: €0/mese - Pro Clinica: €79/mese + IVA (early adopter €49/mese)', 'Pro Clinica gratis per 90 giorni nel Pilot Milano', 'Pagamento sicuro con Stripe', 'I pagamenti clienti vanno direttamente a te'], tip: 'Annulla in qualsiasi momento senza vincoli.' },
