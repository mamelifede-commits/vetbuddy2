...
function ClinicTutorialInline() {
  ...
  const sections = [
    ...
    { icon: CreditCard, title: 'Abbonamento e Pagamenti', color: 'bg-indigo-500', content: ['Starter: €0/mese - Pro Clinica: €79/mese + IVA (early adopter €49/mese)', 'Pro Clinica gratis per 90 giorni nel Pilot Milano', 'Pagamento sicuro con Stripe', 'I pagamenti clienti vanno direttamente al tuo Stripe', 'Gestisci abbonamento da "Impostazioni" → "Gestisci Abbonamento"', 'Per ricevere pagamenti: Impostazioni → Configura Stripe → inserisci chiavi'], tip: 'Le chiavi Stripe si trovano su dashboard.stripe.com/apikeys' },
