...
export default function LabTutorialInline({ onClose }) {
  ...
  const sections = [
    ...
    { icon: CreditCard, title: 'Abbonamento', color: 'bg-slate-500', content: ['Piano Lab Partner: \u20AC39/mese + IVA', 'Pilot: gratuito per i primi 6 mesi', 'Include: profilo nel marketplace, gestione richieste, fatturazione, dashboard', 'Pagamento dell\u2019abbonamento tramite Stripe', 'Puoi annullare in qualsiasi momento senza vincoli'], tip: 'Prezzi IVA esclusa.' },
  ];
