...
export default function OwnerTutorialInline({ onClose }) {
  ...
  const sections = [
    ...
    { icon: FileText, title: 'Modulo pre-visita con foto e video', color: 'bg-purple-500', content: ['Quando prenoti una visita puoi ricevere via email il modulo pre-visita', 'Compila da smartphone: motivo, sintomi, farmaci, alimentazione e urgenza percepita', 'Allega fino a 3 foto o video (max 20MB): la zona interessata o il comportamento del tuo animale', 'Se l\u2019urgenza \u00E8 alta la clinica viene avvisata subito', 'Il veterinario legge tutto prima della visita e arriva preparato'], tip: 'Un breve video del sintomo (es. zoppia, tosse) vale pi\u00F9 di mille parole.' },
    { icon: CheckCircle, title: 'Consensi digitali', color: 'bg-emerald-600', content: ['Prima di una procedura la clinica pu\u00F2 inviarti un consenso da firmare', 'Ricevi il link via email e firmi dallo smartphone in 1 minuto', 'Niente carta e niente attese in accettazione', 'Se dimentichi di firmare ricevi un promemoria automatico'], tip: 'Firma il consenso appena lo ricevi: risparmi tempo a te e alla clinica.' },
    ...
    { icon: Heart, title: 'Piani Salute', color: 'bg-rose-500', content: ['La clinica pu\u00F2 assegnarti un piano salute per il tuo animale', 'I piani includono servizi programmati: visite, vaccini, esami, trattamenti', 'Esempi: Piano Cucciolo (0-12 mesi), Piano Senior (7+ anni), Piano Prevenzione', 'Ricevi promemoria quando un servizio del piano \u00E8 in scadenza', 'Monitora il progresso del piano nella scheda del tuo animale'], tip: 'Chiedi al tuo veterinario se c\u2019\u00E8 un piano salute adatto al tuo animale.' },
  ];
