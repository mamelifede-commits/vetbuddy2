...
export async function generateInvoicePDF(invoice) {
  try {
    ...
    // ========== HEADER ==========
    // Logo/Titolo - New Brand Style (vet + buddy)
    page.drawText('vet', {
      x: 50,
      y: yPos,
      size: 28,
      font: helveticaBold,
      color: darkGray, // dark gray for "vet"
    });
    page.drawText('buddy', {
      x: 85, // positioned after "vet"
      y: yPos,
      size: 28,
      font: helveticaBold,
      color: primaryColor, // coral for "buddy"
    });
    ...
    // FATTURA PROFORMA (destra)
    page.drawText('FATTURA PROFORMA', {
      x: width - 200,
      y: yPos,
      size: 20,
      font: helveticaBold,
    ...
    // Nota PROFORMA
    page.drawText('(Documento non fiscale)', {
      x: width - 200,
      y: yPos - 36,
      size: 8,
      font: helvetica,
    ...
    page.drawText(
      'Questo documento è una pre-fattura di cortesia. Per la fattura fiscale ufficiale contattare la clinica.',
      {
        x: 80,
        y: 52,
        size: 7,
